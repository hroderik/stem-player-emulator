...
2. Press [here](https://github.com/hroderik/stem-player-emulator/raw/main/stem_emulator.user.js), a Tampermonkey tab should open
3. Press install, and you're done

## Mobile Installation (iOS)
1. Install [Userscripts](https://apps.apple.com/us/app/userscripts/id1463298887)
2. Go [here](https://github.com/hroderik/stem-player-emulator/raw/main/stem_emulator.user.js)
